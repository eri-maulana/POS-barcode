         ...
         <div class="card">
            <form action="" method="post" enctype="multipart/form-data">
               ...
               <div class="card-header">
                  <h2 class="card-title pt-2"><i class="fas fa-plus fa-sm mr-2"></i> Tambah Barang</h2>
                  ...
                  <div class="row">
                     <div class="col-lg-8 mb-3 pr-3">
                        <div class="form-group">
                           ...
                           <input type="text" value="<?= generateId(); ?>" name="kode" id="kode" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                           <label for="barcode">Barcode</label>
                           <input type="text" name="barcode" id="barcode" class="form-control" autofocus autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <input type="number" name="harga_jual" id="harga_jual" class="form-control" autocomplete="off">
                        </div>
                        <div class="form-group">
                           <label for="stock_minimal">Stock Minimal</label>
                           <input type="number" name="stock_minimal" id="stock_minimal" class="form-control" autocomplete="off">
                        </div>
                     </div>
                     <div class="col-lg-4 text-center px-3">
                        <img src="<?= $main_url; ?>asset/image/default-brg.png" class="profile-user-img mb-3" alt="">
