...
if ($kode) {
    ...
    if (!mysqli_num_rows($dataBrg)) {
        echo "<script>
                alert('Barang dengan Barcode tersebut tidak tersedia.~');
                document.location.href = '?tgl=$tgl';
            </script>";
    }
}

// source tambah barang ke tabel checkout
...
// menyimpan data tabel checkout ke data table jual head 
    ...
    if (simpan($_POST)) {
        echo "<script>
               ...
               window.onload = function(){
                    let win = window.open('../report/r-struk.php?nota=$nota', 'Struk Belanja', 'left=10, top=10','_blank');
                    if(win){
                        win.focus();
         ...
         <form action="" method="post">
            ...
            <div class="row">
               <div class="col-lg-5 p-3">
                  <div class="form-group row mb-2">
                     <label for="customer" class="col-sm-3 col-form-label col-form-label-sm">Nama Customer</label>
                     <div class="col-sm-9">
